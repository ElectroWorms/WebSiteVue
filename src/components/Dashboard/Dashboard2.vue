...
import {transformDataGraphic2} from './functions'
...
export default {
    ...
    async mounted () {
        ...
        if (this.juego == 'Búsqueda del tesoro'){
            game = 'busquedatesoro'
            this.chartOptions.plugins.title.text = 'Tasa promedio de errores por día en búsqueda del tesoro'
        }
        else if (this.juego == 'Vestir al personaje'){
            game = 'vestirpersonaje'
            this.chartOptions.plugins.title.text = 'Tasa promedio de errores por día en vestir al personaje'
        }
        ...
        try {
            ...
            this.chartData.datasets = [
                {
                    label: 'Tasa promedio de errores',
