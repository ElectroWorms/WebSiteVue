      ...
      >
        ...
        <v-container class="px-0" style="margin-top: 10px">
          <v-container fluid class="px-0"> 
            ...
            <v-list-item  prepend-icon="mdi-account-box-multiple-outline" title="Vincular cuentas"  :to="{ path: '/Vincular' }"></v-list-item>
            <v-divider inset></v-divider>
            <v-list-item  prepend-icon="mdi-monitor-dashboard" title="Dashboard" :to="{ path: '/Dashboard' }"></v-list-item>
            <v-divider inset></v-divider>
